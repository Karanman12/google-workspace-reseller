            ...
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="space-y-6">
              ...
              <div className="p-8 card-concrete-glass flex flex-col gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:Team@workspacebays.com?subject=WorkspaceBays%20Inquiry&body=Hello%20WorkspaceBays%20Team,%0D%0A%0D%0AI%20would%20like%20to%20know%20more%20about%20your%20services.%0D%0A%0D%0AThank%20you." target="_blank" rel="noopener noreferrer" className="text-solar-orange font-bold font-mono tracking-wider hover:underline flex items-center gap-2 cursor-pointer relative z-10 w-fit">
