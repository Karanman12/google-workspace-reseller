...
const About = () => {
  ...
  return (
    <>
      <SEO title="About Us | WorkspaceBays" description="India's Trusted Google Workspace & Cloud Services Partner. We help businesses get set up with professional cloud tools." />
